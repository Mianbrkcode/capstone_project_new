            ...
            <div class="container-fluid">
                <div class="card">
                    <div class="card-header d-flex justify-content-between align-items-center mb-5">
                        <h4 class="m-0">PENDING REPORTS</h4>
                        <a class="btn btn-success m-0 float-end" href="{{ route('sector_initial_report') }}"><i class="bi bi-plus-square-fill"></i> 
        ...
        $('#report-table').on('click', '.delete-reports', function(e) {
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    $.ajax({
                        type: 'PATCH',
                        url: '{{ route("pendingreports.reject", ["report" => "_reportsID_"]) }}'.replace('_reportsID_', reportsID),
                        success: function(response) {
                            Swal.fire(
                                'Rejected!',
