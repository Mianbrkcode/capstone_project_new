        ...
        <main class="content px-3 py-2">
            ...
            <div class="container-fluid mt-3">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb mt-3">
                        ...
                        <li class="breadcrumb-item"><a class="text-muted" href="{{ route('reports') }}"> Active Reports </a></li>
            ...
            <div class="container-fluid">
                <div class="col-lg-12 m-3">
                    <div class="pull-left">
                        <a class="btn btn-primary" href="{{ route('reports') }}"><i class="bi bi-arrow-left-square-fill"></i> BACK</a>
                    </div>
                </div>
                ...
                <div class="container bg-white rounded p-2">
                    ...
                    <form action="{{ route('initialreport.store') }}" id="initialReport" method="POST" enctype="multipart/form-data">
